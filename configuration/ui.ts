...
export const CHAT_HEADER: string = `[Nat Dawg]`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `[Customized AI by Natalie Maloney]`;
export const CLEAR_BUTTON_TEXT: string = `[CLEAR BUTTON TEXT]`;
export const PAGE_TITLE: string = `[PAGE TITLE]`;
export const PAGE_DESCRIPTION: string = `Chat with ${Nat Dawg}, ${Natalie Maloney's}'s AI assistant.`;
